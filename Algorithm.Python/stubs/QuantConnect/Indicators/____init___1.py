...
class ArmsIndex(QuantConnect.Indicators.TradeBarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicator[TradeBar]):
    """
...
class ArnaudLegouxMovingAverage(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class BarIndicator(QuantConnect.Indicators.IndicatorBase[IBaseDataBar], QuantConnect.Indicators.IIndicator, System.IComparable, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class AroonOscillator(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class AverageDirectionalIndex(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class AverageDirectionalMovementIndexRating(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class AverageTrueRange(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class BalanceOfPower(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
