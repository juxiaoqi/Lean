...
class NormalizedAverageTrueRange(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class OnBalanceVolume(QuantConnect.Indicators.TradeBarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicator[TradeBar]):
    """
...
class ParabolicStopAndReverse(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class PercentagePriceOscillator(QuantConnect.Indicators.AbsolutePriceOscillator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class PythonIndicator(QuantConnect.Indicators.IndicatorBase[IBaseData], QuantConnect.Indicators.IIndicator, System.IComparable, System.IComparable[IIndicator[IBaseData]], QuantConnect.Indicators.IIndicator[IBaseData]):
    """
...
class RateOfChangeRatio(QuantConnect.Indicators.RateOfChange, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class RegressionChannel(QuantConnect.Indicators.Indicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class RelativeStrengthIndex(QuantConnect.Indicators.Indicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
