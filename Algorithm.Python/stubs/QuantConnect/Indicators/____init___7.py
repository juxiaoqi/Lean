...
class MidPoint(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class MidPrice(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class Minimum(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class Momentum(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class RateOfChange(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class RateOfChangePercent(QuantConnect.Indicators.RateOfChange, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class MomentumPercent(QuantConnect.Indicators.RateOfChangePercent, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
    This indicator computes the n-period percentage rate of change in a value using the following:
                 100 * (value_0 - value_n) / value_n
...
class MomersionIndicator(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class MoneyFlowIndex(QuantConnect.Indicators.TradeBarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicator[TradeBar]):
    """
