...
class TripleExponentialMovingAverage(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class Trix(QuantConnect.Indicators.Indicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class TrueRange(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class UltimateOscillator(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class VolumeWeightedAveragePriceIndicator(QuantConnect.Indicators.TradeBarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[TradeBar]], QuantConnect.Indicators.IIndicator[TradeBar]):
    """
...
class WilderMovingAverage(QuantConnect.Indicators.Indicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class WilliamsPercentR(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class WindowIdentity(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class WindowIndicator(QuantConnect.Indicators.IndicatorBase[T], QuantConnect.Indicators.IIndicator, System.IComparable, System.IComparable[IIndicator[T]], QuantConnect.Indicators.IIndicator[T]):
    # no doc
    def Reset(self) -> None:
        pass
...
class IndicatorDataPoint(QuantConnect.Data.BaseData, QuantConnect.Data.IBaseData, System.IEquatable[IndicatorDataPoint], System.IComparable, System.IComparable[IndicatorDataPoint]):
    """
