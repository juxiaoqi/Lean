...
class BollingerBands(QuantConnect.Indicators.Indicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class ChandeMomentumOscillator(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class CommodityChannelIndex(QuantConnect.Indicators.BarIndicator, QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IBaseDataBar]], QuantConnect.Indicators.IIndicator[IBaseDataBar]):
    """
...
class CompositeIndicator(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class ConstantIndicator(QuantConnect.Indicators.IndicatorBase[T], QuantConnect.Indicators.IIndicator, System.IComparable, System.IComparable[IIndicator[T]], QuantConnect.Indicators.IIndicator[T]):
...
class CoppockCurve(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class Delay(QuantConnect.Indicators.WindowIndicator[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
...
class DetrendedPriceOscillator(QuantConnect.Indicators.IndicatorBase[IndicatorDataPoint], QuantConnect.Indicators.IIndicator, System.IComparable, QuantConnect.Indicators.IIndicatorWarmUpPeriodProvider, System.IComparable[IIndicator[IndicatorDataPoint]], QuantConnect.Indicators.IIndicator[IndicatorDataPoint]):
    """
